      ...
      <div className="container-wrapper">
        <div className="right-container">
          <div className="aboutme-content">
            ...
            <p className="about-text">Hi! My name is <b>Jenny Huang</b> and welcome to my portfolio! Here's a quick introduction about myself
            ...
            I've always been interested in the field of technology and found I fit best in the middle of front-end and back-end development. 
             My approach to life and code is simplicity at its finest: short and straight-forward code and minimalistic designs are my style.</p>
